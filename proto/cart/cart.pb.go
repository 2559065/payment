...
var file_proto_cart_cart_proto_rawDesc = []byte{
	...
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x63, 0x61, 0x72, 0x74, 0x22, 0x26, 0x0a,
	...
	0x6e, 0x66, 0x6f, 0x52, 0x08, 0x63, 0x61, 0x72, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x7d, 0x0a,
	...
	0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x22, 0x35, 0x0a, 0x04, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x0e,
	...
	0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x32, 0x8e, 0x02, 0x0a, 0x04, 0x43, 0x61, 0x72, 0x74,
	...
	0x12, 0x2a, 0x0a, 0x09, 0x43, 0x6c, 0x65, 0x61, 0x72, 0x43, 0x61, 0x72, 0x74, 0x12, 0x0b, 0x2e,
...
var file_proto_cart_cart_proto_goTypes = []interface{}{
	(*CartFindAll)(nil), // 0: cart.CartFindAll
	(*CartAll)(nil),     // 1: cart.CartAll
	(*CartInfo)(nil),    // 2: cart.CartInfo
	(*ResponseAdd)(nil), // 3: cart.ResponseAdd
	(*Clean)(nil),       // 4: cart.Clean
	(*Response)(nil),    // 5: cart.Response
	(*Item)(nil),        // 6: cart.Item
	(*CartID)(nil),      // 7: cart.CartID
}
var file_proto_cart_cart_proto_depIdxs = []int32{
	2, // 0: cart.CartAll.cart_info:type_name -> cart.CartInfo
	2, // 1: cart.Cart.AddCart:input_type -> cart.CartInfo
	4, // 2: cart.Cart.ClearCart:input_type -> cart.Clean
	6, // 3: cart.Cart.Incr:input_type -> cart.Item
	6, // 4: cart.Cart.Decr:input_type -> cart.Item
	7, // 5: cart.Cart.DeleteItemByID:input_type -> cart.CartID
	0, // 6: cart.Cart.GetAll:input_type -> cart.CartFindAll
	3, // 7: cart.Cart.AddCart:output_type -> cart.ResponseAdd
	5, // 8: cart.Cart.ClearCart:output_type -> cart.Response
	5, // 9: cart.Cart.Incr:output_type -> cart.Response
	5, // 10: cart.Cart.Decr:output_type -> cart.Response
	5, // 11: cart.Cart.DeleteItemByID:output_type -> cart.Response
	1, // 12: cart.Cart.GetAll:output_type -> cart.CartAll
